...
struct lock {
	...
	int is_held; // indicates if this lock is locked
	struct thread *holder;// thread the holds this lock
	struct queue *block_thread; //queue that holds the locked threads 
